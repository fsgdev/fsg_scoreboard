...
CreateThread( function()
    if Config.CheckVersion then
  	...
  	PerformHttpRequest('https://raw.githubusercontent.com/alvwashere/ScriptVersions/master/[NAME HERE]_version', function(code, res, headers)
  		if code == 200 then
  			local rv = json.decode(res)
  			if tonumber(table.concat(mysplit(rv.version, "."))) > tonumber(table.concat(mysplit(version, "."))) then
  					print(([[
^6[ALV-GG]^0 [NAME HERE] Script Loaded
^6[ALV-GG]^0 The system is ^2NOT^0 up to date.
^6[ALV-GG]^0 Changelog: ^4%s ^0
^6[ALV-GG]^0 Please update here: ^1https://github.com/alvwashere/[NAME HERE]/releases^0.
